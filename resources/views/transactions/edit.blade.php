...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="page-title">تحديث الملاحظة</h2>
            <div class="card-deck">
                        ...
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="note" id="note" rows="4" class="form-control" placeholder="أدخل الملاحظة">{{ old('note', $transaction->note) }}</textarea>
                                </div>
                            </div>

                      ...
                      <form class="form-inline">
                        <div class="form-row">
                          ...
                          <div class="form-group col-auto ml-3">
                            ...
                            <!-- Date Range -->
                            <div class="form-group col-auto ml-3" id="date-container-1">
                                <label for="start_date" class="sr-only">تاريخ البدء</label>
                                <input type="text" class="form-control" id="start_date" name="start_date" value="{{ request()->input('start_date') }}" placeholder="تاريخ الاستلام">
                            </div>
                            <div class="form-group col-auto ml-3" id="date-container-2">
                                <label for="end_date" class="sr-only">تاريخ الانتهاء</label>
                                <input type="text" class="form-control" id="end_date" name="end_date" value="{{ request()->input('end_date') }}" placeholder="تاريخ الرجوع">
                            </div>
                        </div>
                        </div>
                      </form>
